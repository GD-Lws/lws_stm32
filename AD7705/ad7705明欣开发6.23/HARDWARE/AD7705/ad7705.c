...
#define CS_ADC_LOW()    GPIO_ResetBits(GPIOB,GPIO_Pin_1)   
#define CS_ADC_HIGH()   GPIO_SetBits(GPIOB,GPIO_Pin_1)

void AD7705_IO_Init(void){
	GPIO_InitTypeDef GPIO_InitStructure;
	
	RCC_APB2PeriphClockCmd(RCC_AHB1Periph_GPIOC|RCC_APB2Periph_SPI1|RCC_AHB1Periph_GPIOB, ENABLE);
